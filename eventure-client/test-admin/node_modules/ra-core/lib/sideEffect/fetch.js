        ...
        switch (_b.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        meta: __assign({}, meta, successSideEffects, { fetchResponse: restType, fetchStatus: actions_1.FETCH_END }),
                    })];
            case 5:
                _b.sent();
            ...
            case 7:
                ...
                return [4 /*yield*/, effects_1.put({
                        ...
                        requestPayload: payload,
                        meta: __assign({}, meta, failureSideEffects, { fetchResponse: restType, fetchStatus: actions_1.FETCH_ERROR }),
                    })];
            case 8:
                _b.sent();
