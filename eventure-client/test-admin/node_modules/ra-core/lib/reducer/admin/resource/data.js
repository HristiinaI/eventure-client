...
exports.addRecords = function (newRecords, oldRecords) {
    ...
    Object.defineProperty(newRecordsById, 'fetchedAt', {
        value: __assign({}, oldRecords.fetchedAt, updatedFetchedAt),
        enumerable: false,
    });
...
exports.addOneRecord = function (newRecord, oldRecords, date) {
    ...
    var newRecordsById = __assign({}, oldRecords, (_a = {}, _a[newRecord.id] = isEqual_1.default(newRecord, oldRecords[newRecord.id])
        ? oldRecords[newRecord.id] // do not change the record to avoid a redraw
        : newRecord, _a));
    return Object.defineProperty(newRecordsById, 'fetchedAt', {
        value: __assign({}, oldRecords.fetchedAt, (_b = {}, _b[newRecord.id] = date, _b)),
        enumerable: false,
    });
};
/**
