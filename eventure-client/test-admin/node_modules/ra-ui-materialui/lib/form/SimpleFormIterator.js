...
var SimpleFormIterator = /** @class */ (function (_super) {
    ...
    SimpleFormIterator.prototype.render = function () {
        ...
        return fields ? (react_1.default.createElement("ul", { className: classes.root },
            ...
            react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: null }, fields.map(function (member, index) { return (react_1.default.createElement(react_transition_group_1.CSSTransition, __assign({ key: _this.ids[index], timeout: 500, classNames: "fade" }, TransitionProps),
