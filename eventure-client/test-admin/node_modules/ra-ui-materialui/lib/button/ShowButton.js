...
var ShowButton = function (_a) {
    ...
    return (react_1.default.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, to: ra_core_1.linkToRecord(basePath, record && record.id) + "/show", label: label, onClick: stopPropagation }, rest), icon));
};
